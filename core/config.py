...
@dataclass
class StorageConfig:
    database_path: str = "~/.neonarc/neonarc.db"
    vector_store: str = "faiss"
    vector_store_path: str = "~/.neonarc/faiss/index.faiss"
...
@dataclass
class NeonArcConfig:
    """Configuration settings for NeonArc."""
    # Storage paths
    data_dir: str = "~/.neonarc"
    db_path: str = "~/.neonarc/neonarc.db"
    vector_store_path: str = "~/.neonarc/faiss/index.faiss"
...
class ConfigManager:
    """Manages NeonArc configuration."""
    
    def __init__(self, db_manager=None):
        self.config = NeonArcConfig()
    ...
    def _load_from_env(self):
        ...
        for field in self.config.__dataclass_fields__:
            env_var = f"NEONARC_{field.upper()}"
...
DEFAULT_CONFIG = {
    "storage": {
        "database_path": "~/.neonarc/neonarc.db", # Use absolute path with ~/.neonarc/
        "vector_store": "faiss",
        "vector_store_path": "~/.neonarc/faiss/index.faiss",
