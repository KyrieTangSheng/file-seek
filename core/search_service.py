...
from pipeline.embedding_module import EmbeddingGenerator
...
class SearchService:
    ...
    def search(self, 
        ...
        Args:
            ...
            return_raw: If True, also return raw query embedding
            
        Returns:
            List of SearchResult objects, optionally with query embedding
        """
        try:
            # Generate query embedding
            query_embedding = self.embedding_generator([query])[0]
            ...
            for chunk_id, score in zip(chunk_ids, scores):
                ...
                # Parse chunk ID to get document ID and chunk index
